...
- **[bare](https://github.com/nicolo-ribaudo/bare)** / **[bare-native](https://github.com/nicolo-ribaudo/bare-native)** — Runtime and native app builds (macOS, Android)
...
- **[distributed-drive](https://github.com/nicolo-ribaudo/distributed-drive)** — Aggregates multiple drives (local, remote) with RPC over protomux
- **[localdrive](https://github.com/holepunchto/localdrive)** — File system drive interface
- **[cellery](https://github.com/nicolo-ribaudo/cellery)** / **[cellery-html](https://github.com/nicolo-ribaudo/cellery-html)** — Reactive UI cells over WebSocket
...
- No hyperdrive or git remote drive support yet
